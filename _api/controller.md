...
info:
  ...
  description: >-
    The controller provides APIs to the developer for configuring rules for
    request routing, fault injection, etc.
  version: 1.0.0
basePath: /
schemes:
  - http
...
paths:
  ...
  /v1/rules:
    ...
    post:
      ...
      description: |
        Transactionally add rules to the controller. All rules are validated
    ...
    get:
      ...
      description: >-
        Query for rules that pass the specified filters. Filters are specified
    ...
    put:
      ...
      description: >-
        Transactionally update the specified rules. No rules are updated on
        failure.
      parameters:
        - name: rules
          in: body
