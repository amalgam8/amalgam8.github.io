...
securityDefinitions:
  tokenAuth:
    ...
    in: header
    description: >-
      APIKEY Authentication. Works over `HTTP(S)`. Required for namespace
      authorization.
paths:
  /api/v1/services:
    get:
  ...
  '/api/v1/services/{service_name}':
    get:
      ...
      description: >-
        Returns a list of all registered instances for service named
        {service_name}
      consumes:
        - application/json
      produces:
    ...
    get:
      ...
      parameters:
        - name: fields
          in: query
          description: >-
            Comma separated list of instance fields to include in the response.
        ...
        - name: tags
          in: query
          description: >-
            Comma separated list of tags of the instances. Only instances
  ...
  '/api/v1/instances/{id}/heartbeat':
    put:
      ...
      description: >-
        Sends a heartbeat for an existing service instance registration. Failing
        to renew the registration will result in the instance being removed from
        the registry.
      consumes:
        - application/json
      produces:
  ...
  Endpoint:
    properties:
      ...
      value:
        type: string
        description: >-
          Endpoint value, formatted according to the defined type (e.g.,
          host[:port] for 'tcp').
  Instance:
    properties:
      service_name:
      ...
      ttl:
        ...
        format: int64
        description: >-
          Client's requested time to live, measured in seconds. The value may be
      ...
      metadata:
        description: >-
          Optional user metadata. The value can be null, a primitive, an array
  ...
  Service:
    properties:
      service_name:
        type: string
        description: >-
          Unique identifier representing the service name. For example, mysql,
